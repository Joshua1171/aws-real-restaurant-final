...
/**
 * Manejador global de excepciones. Mapea excepciones de la aplicación a respuestas
 * HTTP estructuradas siguiendo RFC 7807 (Problem Details for HTTP APIs) de forma simplificada.
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleNotFound(final ReservationNotFoundException ex) {
        LOGGER.warn("Reservación no encontrada: {}", ex.getMessage());
        return buildErrorResponse(HttpStatus.NOT_FOUND, "Reservación no encontrada", ex.getMessage());
    }
    ...
    public ResponseEntity<Map<String, Object>> handleGenericException(final Exception ex) {
        ...
        return buildErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR,
                ...
                "Ocurrió un error al procesar la solicitud. Revisa los logs del servicio.");
    }
